...
import {EngineUtils, SPRITE_LAYER} from "../../engine/engine.js";
import {CAT_STAGE_LAST_HIT} from "./bonusStageCat.js";

export const COIN_MULTIPLIER_BLINKING_FRAMES = 6; //Frame count between visible and not visible while blinking
...
export const COIN_HIGH_SLOT_1 = 62;
export const COIN_HIGH_SLOT_2 = 98;
export const COIN_HIGH_SLOT_3 = 135;
export const COIN_HIGH_SLOT_4 = 172;
export const COIN_HIGH_SLOT_5 = 208;
export const COIN_HIGH_SLOT_6 = 244;
export const COIN_HIGH_SLOT_7 = 278;
export const COIN_HIGH_SLOT_8 = 314;

//Horizontal positions for the coins on the lower row
export const COIN_LOW_SLOT_1 = 100;
export const COIN_LOW_SLOT_2 = 135;
export const COIN_LOW_SLOT_3 = 170;
export const COIN_LOW_SLOT_4 = 205;
export const COIN_LOW_SLOT_5 = 240;
export const COIN_LOW_SLOT_6 = 275;
