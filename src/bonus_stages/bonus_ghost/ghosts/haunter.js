...
import {SmallGhost} from "./smallGhost.js";
...
export class Haunter extends SmallGhost {
    constructor(x, y, onHitCallback) {
        ...
        this.idleAnimation = Asset.getAnimation('animHaunter');
        this.hurtAnimation = Asset.getAnimation('animHaunterHurt');
