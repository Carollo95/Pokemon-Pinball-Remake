...
import {BALL_LAYER, EPSILON} from "../engine/engine.js";
...
export const FLIPPER_SFX_PLAY_COOLDOWN = 200; //Cooldown betwen flipper sfx plays to avoid spamming
...
export function createTableFlippers() {
...
export function createBonusFlippers() {
