...
import {DEFAULT_TEXT_PERSISTENCE_MILLIS} from "./stageText.js";
import {EngineUtils, SCENARIO_LAYER} from "../engine/engine.js";
import {DEBUG} from "../engine/cheatEngine.js";

export const DEFAULT_SHAKE_DURATION_MS = 300; // default shake duration in milliseconds

export class Stage extends Sketch{
