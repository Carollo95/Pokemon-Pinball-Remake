...
import {Arrows, FIELD_ARROWS_BLINK_HALF_RATE, FIELD_ARROWS_BLINK_RATE} from "../arrows.js";
import {BLUE_ARROW_DIRECTION} from "./blueArrow.js";

export class BlueFieldArrows extends Arrows {
    ...
    blinkLeftInnerArrow(visible) {
        if (visible) {
            frameCount % FIELD_ARROWS_BLINK_RATE > FIELD_ARROWS_BLINK_HALF_RATE ?
                this.leftInnerArrow.ani.frame = this.leftInnerArrowExtraFrames :
                this.leftInnerArrow.ani.frame = this.evolutionArrowsLevel >= 3 ? 1 + this.leftInnerArrowExtraFrames : this.leftInnerArrowExtraFrames;
        } else {
            this.leftInnerArrow.ani.frame = this.leftInnerArrowExtraFrames;
        }
    }
