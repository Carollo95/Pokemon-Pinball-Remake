...
import {CHAR_TYPE, StageCharacter} from "../core/stageCharacter.js";
import {EventTimer} from "../core/eventTimer.js";
...
export const BONUS_BALL_SCREEN_LINES = {
    NONE: "None",
...
export const RED_FIELD_BALL_SCREEN_LINES_ORDER = [
...
export const BLUE_FIELD_BALL_SCREEN_LINES_ORDER = [
    BONUS_BALL_SCREEN_LINES.NONE,
    BONUS_BALL_SCREEN_LINES.POKEMON_CAUGHT,
    BONUS_BALL_SCREEN_LINES.POKEMON_EVOLVED,
