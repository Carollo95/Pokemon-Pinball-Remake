...
import {EngineUtils, SCREEN_HEIGHT, setStage} from "../engine/engine.js";
import {Stage} from "../core/stage.js";
import {Ball} from "../core/ball.js";
import {Controls} from "../core/controls.js";
import {CaveDetectorManager} from "./caveDetectorManager.js";
import {BallBonusScreen} from "./ballBonusScreen.js";
import {SLOT_STATES, StartSlotMachineParams} from "./screenSlot.js";
import {MultiplierManager} from "./multiplierManager.js";
import {StageWell} from "./stageWell.js";
import {EvolutionManager} from "./evolutionManager.js";
import {SaverAgain} from "./saverAgain.js";
import {I18NManager} from "../engine/i18nManager.js";
import {SCREEN_STATE} from "./screen.js";
import {Timer} from "../core/timer.js";
import {getEvolution, saveObtainedPokemon, saveSeenPokemon} from "../core/dex.js";
import {EvolutionChooserScreen} from "./evolutionChooserScreen.js";
import {createTableFlippers} from "../core/flippers.js";
import {DEFAULT_TEXT_PERSISTENCE_MILLIS, createStageStatusBanner} from "../core/stageText.js";
...
export class Field extends Stage {
    constructor(status) {
        super(status);
    ...
    onBackFromBonusStageCallback = () => {
        ...
        this.setup(this.screen.screenLandscapes.currentLandmark, this.arrows.getState(), true, this.pikachuSaverManager.getState(), this.multiplierManager.multiplier, this.caveActive);
