...
class Pokedex extends Sketch {
    ...
    createNumberRows() {
        ...
        for(let i = 0; i < ALL_POKEMON.length; i++){
            this.rows.push(new PokedexPokemon(ALL_POKEMON[i], POKEXEX_ROW_NUMBER_YS[i], true));
        }
